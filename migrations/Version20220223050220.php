 ...
 */
final class Version20220223050220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercice ADD exc_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exercice ADD CONSTRAINT FK_E418C74D90CAD08B FOREIGN KEY (exc_id) REFERENCES exc (id)');
        $this->addSql('CREATE INDEX IDX_E418C74D90CAD08B ON exercice (exc_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercice DROP FOREIGN KEY FK_E418C74D90CAD08B');
        $this->addSql('DROP INDEX IDX_E418C74D90CAD08B ON exercice');
        $this->addSql('ALTER TABLE exercice DROP exc_id, CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(500) NOT NULL COLLATE `utf8mb4_unicode_ci`');
