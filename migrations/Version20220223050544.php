 ...
 */
final class Version20220223050544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prog_muscul ADD espace_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prog_muscul ADD CONSTRAINT FK_4B7F61C3B6885C6C FOREIGN KEY (espace_id) REFERENCES espace (id)');
        $this->addSql('CREATE INDEX IDX_4B7F61C3B6885C6C ON prog_muscul (espace_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prog_muscul DROP FOREIGN KEY FK_4B7F61C3B6885C6C');
        $this->addSql('DROP INDEX IDX_4B7F61C3B6885C6C ON prog_muscul');
        $this->addSql('ALTER TABLE prog_muscul DROP espace_id, CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
